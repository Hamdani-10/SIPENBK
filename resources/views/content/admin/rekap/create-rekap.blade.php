...
@section('title', 'Tambah Laporan BK')
@section('page-title', 'Tambah Laporan BK')
...
@section('content')
    ...
    <nav class="flex items-center text-sm text-gray-500 mb-6 space-x-2">
        ...
        <span>/</span>
        <span class="text-gray-700 font-semibold">Tambah Laporan BK</span>
    </nav>

    {{-- Card Form --}}
    <div class="bg-white p-6 rounded-2xl">
        <h2 class="text-xl font-semibold text-gray-800 mb-6">Form Tambah Laporan BK</h2>

        <form action="{{ route('admin.rekap.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <textarea name="hasil_bk" id="hasil_bk" rows="4"
                    ...
                    placeholder="Tuliskan hasil bimbingan konseling...">{{ old('hasil_bk') }}</textarea>
                @error('hasil_bk')
                    <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <textarea name="catatan_tambahan" id="catatan_tambahan" rows="3"
                    ...
                    placeholder="Isi catatan tambahan (opsional)...">{{ old('catatan_tambahan') }}</textarea>
            ...
            <div class="flex flex-col md:flex-row justify-between items-center pt-6 space-y-3 md:space-y-0 md:space-x-4">
                <button type="submit"
                    ...
                    <i data-feather="save" class="w-4 h-4"></i> Simpan Laporan BK
                </button>
